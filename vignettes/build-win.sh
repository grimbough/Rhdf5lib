...
cd /tmp/
mkdir -p /tmp/winlibs/hdf5-${ver}${patch}/i686
...
pacman -Sy --needed msys2-runtime-devel

export PATH=/c/rtools40/mingw32/bin:/usr/bin
export CPATH=/c/rtools40/mingw32/i686-w64-mingw32/include:/c/rtools40/mingw32/include:/usr/include
export LD_LIBRARY_PATH=/c/rtools40/mingw32/i686-w64-mingw32/lib:/c/rtools40/mingw32/lib:/usr/lib
...
cp bin/lib*.a /tmp/winlibs/hdf5-${ver}${patch}/i686

## MSYS, Rtools 3.9, 64bit
export PATH=/c/rtools40/mingw64/bin:/usr/bin
export CPATH=/c/rtools40/mingw64/x86_64-w64-mingw32/include:/c/rtools40/mingw64/include:/usr/include
export LD_LIBRARY_PATH=/c/rtools40/mingw64/x86_64-w64-mingw32/lib:/c/rtools40/mingw64/lib:/usr/lib
cd /c/rtools40/tmp/CMake-hdf5-${ver}${patch}/hdf5-${ver}${patch}
...
export CPATH=/c/rtools40/ucrt64/x86_64-w64-mingw32/include:/c/rtools40/ucrt64/include:/usr/include
export LD_LIBRARY_PATH=/c/rtools40/ucrt64/x86_64-w64-mingw32/lib:/c/rtools40/ucrt64/lib:/usr/include
